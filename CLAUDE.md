...
.github/workflows/
  ...
  auto_morning.yml         土日 7:00 JST 全レース予想ファイル→Discord
  auto_review.yml          土日 18:00 JST 振り返り→Discord
  health_check.yml         日曜 21:00 JST 成績CSV未蓄積を検知→Discord警告
...
| ワークフロー | トリガー | 内容 |
|---|---|---|
| auto_morning.yml | 土日 7:00 JST | 全レース予想を .txt/.html で投稿（9時前投稿確実化のため8:00→7:00に前倒し 2026-09-19） |
| auto_predict.yml | 土日 9:00〜16:45 JST 15分ごと | 発走10〜60分前のレースを自動予想 |
| auto_review.yml | 土日 18:00 JST | 当日振り返りを投稿（19:30→18:00 2026-09-19。⚠️真夏は最終18:30で未確定リスクあり） |
| auto_weekend_summary.yml | 日曜 20:30 JST | 土日合算まとめを投稿 |
| health_check.yml | 日曜 21:00 JST | 成績CSVに今週末の行が無ければDiscord警告（サイレント障害の見張り番 2026-09-19） |
